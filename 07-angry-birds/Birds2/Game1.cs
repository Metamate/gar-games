...
public class Game1 : Core
{
    ...
    private void StartLevel()
    {
        ...
        _entities.Add(new Block(_physics, new Vector2(880, 590), post, 0, Materials.Wood, 8, 500, _atlas.GetRegion("wood-post")));
        _entities.Add(new Block(_physics, new Vector2(1040, 590), post, 0, Materials.Wood, 8, 500, _atlas.GetRegion("wood-post")));
        _entities.Add(new Block(_physics, new Vector2(960, 530), new Vector2(180, 20), 0, Materials.Wood, 8, 500, _atlas.GetRegion("wood-plank")));
        _entities.Add(new Pig(_physics, new Vector2(960, 618), 22, 3, 5000, _atlas.GetRegion("pig")));
        _entities.Add(new Block(_physics, new Vector2(960, 495), new Vector2(50, 50), 0, Materials.Glass, 4, 500, _atlas.GetRegion("glass-box")));
        _entities.Add(new Pig(_physics, new Vector2(960, 448), 22, 3, 5000, _atlas.GetRegion("pig")));
    }
