...
public class Ghost : Actor
{
    ...
    public Ghost(World world, string name, Point start, Point scatterTarget, float releaseDelay, ITargetStrategy targeting) : base(world.Maze)
    {
        World = world;
        Name = name;
        Start = start;
