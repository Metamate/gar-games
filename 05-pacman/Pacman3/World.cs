...
public class World
{
    ...
    public World(string mazeText, Random random = null)
    {
        ...
        // longer in the house.
        Blinky = new Ghost(this, "blinky", Maze.StartOf('b'), new Point(Maze.Width - 3, -3), 0, new ChasePacMan());
        Pinky = new Ghost(this, "pinky", Maze.StartOf('p'), new Point(2, -3), 0, new AmbushAhead());
        Inky = new Ghost(this, "inky", Maze.StartOf('i'), new Point(Maze.Width - 1, Maze.Height + 1), 4, new FlankWithBlinky());
        Clyde = new Ghost(this, "clyde", Maze.StartOf('c'), new Point(0, Maze.Height + 1), 8, new ChaseUntilClose());
